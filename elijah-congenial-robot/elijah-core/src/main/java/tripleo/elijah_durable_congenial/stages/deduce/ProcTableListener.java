...
import tripleo.elijah_durable_congenial.nextgen.rosetta.RosettaApplyable;
...
public class ProcTableListener implements BaseTableEntry.StatusListener {
	...
	private void resolved_element_pte_ClassStatement(final @Nullable Constructable co,
		...
		final RegisterClassInvocation_env  env  = new RegisterClassInvocation_env(ci, deduceTypes2, deduceTypes2.getPhase());
