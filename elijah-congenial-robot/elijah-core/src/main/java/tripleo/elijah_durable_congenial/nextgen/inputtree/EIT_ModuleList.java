...
import tripleo.elijah_durable_congenial.comp.Coder;
import tripleo.elijah.comp.PipelineLogic;
import tripleo.elijah_durable_congenial.entrypoints.EntryPointList;
...
public class EIT_ModuleList {
	...
	private void __process__PL__each(final @NotNull _ProcessParams plp) {
		...
		final GeneratedClasses lgc = plp.getLgc();
...
//			}
	...
	private static class _ProcessParams {
		...
		@Contract(pure = true)
		public @NotNull GeneratedClasses getLgc() {
