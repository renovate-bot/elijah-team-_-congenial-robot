 ...
 */
public class SpinBox extends TextField {
	public SpinBox(OWThinlet thinlet, Object component) {
		super(thinlet, component);
	}

	public SpinBox(OWThinlet thinlet) {
		super(thinlet, Thinlet.create(ThinletConstants.SPINBOX));
	}
	...
	public int getStep() {
		return fthinlet.getInteger(unwrap(), ThinletConstants.STEP);
	}

	public void setStep(int value) {
		fthinlet.setInteger(unwrap(), ThinletConstants.STEP, value);
	}
