...
public class CheckBoxMenuItem extends MenuItem {
	...
	public CheckBoxMenuItem(OWThinlet thinlet, Object component) {
		super(thinlet, component);
	}

	public CheckBoxMenuItem(OWThinlet thinlet) {
		super(thinlet, Thinlet.create(ThinletConstants.CHECKBOXMENUITEM));
	}
