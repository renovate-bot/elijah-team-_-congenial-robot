...
public class TextArea extends TextField {
	public TextArea(OWThinlet thinlet, Object component) {
		super(thinlet, component);
	}

	public TextArea(OWThinlet thinlet) {
		super(thinlet, Thinlet.create(ThinletConstants.TEXTAREA));
	}

	public int getRows() {
		return fthinlet.getInteger(unwrap(), ThinletConstants.ROWS);
	}

	public void setRows(int value) {
		fthinlet.setInteger(unwrap(), ThinletConstants.ROWS, value);
	}
	...
	public boolean isWrap() {
		return fthinlet.getBoolean(unwrap(), ThinletConstants.WRAP);
	}

	public void setWrap(boolean value) {
		fthinlet.setBoolean(unwrap(), ThinletConstants.WRAP, value);
	}
}
