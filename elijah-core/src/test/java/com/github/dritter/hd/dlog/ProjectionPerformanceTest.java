...
public class ProjectionPerformanceTest {
    ...
    //    vv(edbRelationsSize, measurementsNumber);
    //}

    public ProjectionPerformanceTest() {

    }

    private void vv(final int edbRelationsSize, final int measurementsNumber) {
        /*
         * p(W, Z) :- r(W, X, Y, Z).
         *
         * r(1, 1, 1, 1).
    ...
    @Test
    public void testProjectionPerformance() throws IOException {
        int edbRelationsSize = 3;
        int measurementsNumber = 5;
        final ProjectionPerformanceTest projectionPerformanceTest = new ProjectionPerformanceTest();
        projectionPerformanceTest.vv(edbRelationsSize, measurementsNumber);
        projectionPerformanceTest.testDlogPerformance();
    }
