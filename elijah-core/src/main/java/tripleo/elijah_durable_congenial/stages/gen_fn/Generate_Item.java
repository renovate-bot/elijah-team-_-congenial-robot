...
//						final IExpression right1 = bbe.getRight();
				...
				final @NotNull List<TypeTableEntry> argument_types = List_of(gf.getVarTableEntry(DeduceTypes2.to_int(left)).getType(), gf.getVarTableEntry(DeduceTypes2.to_int(right)).getType());
