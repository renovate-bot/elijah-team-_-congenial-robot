...
import tripleo.elijah_durable_congenial.stages.deduce.nextgen.DR_Variable;
...
import tripleo.elijah_durable_congenial.stages.gen_fn.DeferredObject2;
...
public class DeduceProcCall {
	...
	public DeduceProcCall(final @NotNull ProcTableEntry aProcTableEntry) {
		...
		procTableEntry.onAttachEva(evaFunction -> {
