...
public class PasswordField extends TextField {
	public PasswordField(OWThinlet thinlet, Object component) {
		super(thinlet, component);
	}

	public PasswordField(OWThinlet thinlet) {
		super(thinlet, Thinlet.create(ThinletConstants.PASSWORDFIELD));
	}
